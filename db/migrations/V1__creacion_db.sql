...
CREATE TABLE IF NOT EXISTS urb.ruta (
  ...
  tipo_camion INT NOT NULL,
  CONSTRAINT fk_ruta_tipo_camion
    FOREIGN KEY (tipo_camion) REFERENCES urb.tipo_camion(id)
);
...
-- 14) urb.ruta_base
-- =========================================================
CREATE TABLE IF NOT EXISTS urb.ruta_base (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  id_ruta BIGINT NOT NULL,
  fecha_creacion TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT NOW(),
  activa BOOLEAN NOT NULL DEFAULT TRUE,
  CONSTRAINT fk_ruta_base_ruta
    FOREIGN KEY (id_ruta) REFERENCES urb.ruta(id)
);
...
CREATE TABLE IF NOT EXISTS urb.ruta_base_posicion (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  id_ruta_base BIGINT NOT NULL,
  latitud DOUBLE PRECISION NOT NULL,
  longitud DOUBLE PRECISION NOT NULL,
  orden INT NOT NULL,
  CONSTRAINT fk_ruta_base_posicion_ruta_base
    FOREIGN KEY (id_ruta_base) REFERENCES urb.ruta_base(id) ON DELETE CASCADE,
  CONSTRAINT uq_ruta_base_posicion_orden UNIQUE (id_ruta_base, orden)
);
...
-- =========================================================
CREATE TABLE IF NOT EXISTS urb_sistema.usuario_estado (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS urb.precio_ruta (
  ...
  CONSTRAINT fk_precio_ruta_estado
    FOREIGN KEY (estado) REFERENCES urb.estado(id)
);
